...
| Matheus Pinheiro | Criação de nova versão (1.1) para o diagrama de componentes e atualização no uso de IA (para pesquisa de como criar o menu colapsável de versões) | 18/09/2026 |
